...
{CafeTownsendApp:function(){function a(a,d,c,e,g,h){var f=this;this.sessionService=a;this.$location=c;this.$window=g;e.log("initializing CafeTownsend routes...");d.when("/login",{template:"assets/tmpl/login.html",controller:com.mindspace.cafetownsend.controller.LoginController});d.when("/employee",{template:"assets/tmpl/employees.html",controller:com.mindspace.cafetownsend.controller.EmployeeController});d.when("/employee/:id",{template:"assets/tmpl/employee_edit.html",controller:com.mindspace.cafetownsend.controller.EmployeeEditController});
